...
const Home = () => {
  return (
    ...
    > 
      ...
      <a href="/Tutorial" className="text-white gba text-xl animate-bounce relative ">
        How to contribute
      </a>
      <AudioControl />
      <img src={p2} className="absolute bottom-4 left-40"/>
      <img src={p8} className="absolute bottom-8 right-40"/>
